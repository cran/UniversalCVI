#' @title R2 Artificial Dataset
#' @description A \code{2}-dimensional dataset from Wiroonsri and Preedasawakul (2023) generated from \code{7} different Gaussian distributions labeled as \code{1-7}.
#' @format A data frame with 1750 data points and 3 variables
#' \describe{
